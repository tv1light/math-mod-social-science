...
def catastrophe_scenario():
    ...
    catastrophe_params = (normal_params[0], normal_params[1], normal_params[2])  # Измененные параметры
    ...
    final_conditions_pre = [sol_pre.y[0, -1] * 0.5, sol_pre.y[1, -1] * 0.5, sol_pre.y[2, -1] * 0.5 ]
