...
def catastrophe_scenario():
    ...
    catastrophe_params = (normal_params[0]*0.5, normal_params[1]*0.5, normal_params[2]*0.5)  # Измененные параметры
    ...
    t_split = 1962  # Год наступления катастрофы пик холодной войны
    ...
    final_conditions_pre = [sol_pre.y[0, -1] * 0.17, sol_pre.y[1, -1] * 0.16, sol_pre.y[2, -1] * 0.14 ]
