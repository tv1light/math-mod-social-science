...
def pandemic_scenario():
    ...
    catastrophe_params = (
    normal_params[0] * 0.7, normal_params[1] * 0.3, normal_params[2] * 0.7)  # Измененные параметры
    ...
    t_split = 1961  # Год наступления катастрофы
    ...
    final_conditions_pre = [sol_pre.y[0, -1] * 0.5, sol_pre.y[1, -1] * 0.4, sol_pre.y[2, -1] * 0.8]
